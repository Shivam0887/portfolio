        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <div className="flex items-center gap-3">
            <Tabs
              ...
              className="bg-white/3 p-1 rounded-full border border-white/5"
            >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            value={form.slug}
                            readOnly
                            className="w-full px-5 py-3.5 rounded-xl bg-white/[0.03] border border-white/[0.05] outline-none transition-all font-mono text-[10px] text-white/40 cursor-not-allowed"
                          />
                        </div>
                      </div>
