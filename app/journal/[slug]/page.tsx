      ...
      <article className="max-w-3xl mx-auto space-y-12">
        ...
        <header className="space-y-8 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            {/* Use dynamic title */}
            <h1 className="text-4xl md:text-6xl font-medium tracking-tight leading-[1.1]">{post.title}</h1>
            ...
            <div key={idx} className="space-y-6">
              ...
              {section.type === "code" && (
                <div className="bg-secondary/30 border border-border/50 rounded-2xl p-8 font-mono text-sm overflow-hidden relative group">
                  ...
                  <code className="block whitespace-pre text-foreground/90 overflow-x-auto">{section.content}</code>
                </div>
              )}
            </div>
          ))}
        ...
        <footer className="pt-20 pb-10">
          <div className="glass rounded-3xl p-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-2 text-center md:text-left">
              <p className="text-sm font-mono text-muted-foreground uppercase tracking-widest">Written By</p>
              <h4 className="text-xl font-medium">{post.author || "Technical Architect"}</h4>
            </div>
