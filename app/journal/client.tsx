...
export function JournalClientWrapper({ posts }: JournalClientWrapperProps) {
  return (
        ...
        <div className="max-w-[1800px] mx-auto">
          ...
          >
            ...
            >
              ...
              , engineering logs, and architectural explorations.
            </motion.p>
          </motion.div>
        </div>
      </section>
  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative block py-16 md:py-24 lg:py-28 overflow-hidden"
      >
        {/* Sliding Background Effect */}
        <div className="absolute inset-0 bg-gradient-to-r from-amber-400/[0.05] via-amber-400/[0.02] to-transparent origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]" />
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-start justify-between gap-8 pl-0 group-hover:pl-8 transition-all duration-500">
          <div className="flex items-start gap-8 md:gap-12 lg:gap-16 flex-1">
            {/* Number */}
            ...
            <div className="space-y-6 flex-1">
              ...
              <div className="flex flex-wrap items-center gap-4 md:gap-6">
                <motion.span
                  className="px-4 py-1.5 text-[10px] font-mono uppercase tracking-[0.15em] bg-white/[0.02] border border-white/[0.04] text-white/35 group-hover:border-amber-300/20 group-hover:text-amber-300/70 transition-all duration-500"
              ...
              {/* Title */}
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-black tracking-[-0.02em] uppercase leading-[1.05]">
              ...
              {/* Excerpt */}
              <p className="text-base md:text-lg text-white/25 max-w-2xl leading-relaxed group-hover:text-white/45 transition-colors duration-500 line-clamp-2">
                {post.excerpt}
              </p>
            </div>
          </div>
          ...
          {/* Arrow */}
          <div className="hidden lg:flex items-center gap-8 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-8 group-hover:translate-x-0 pt-6">
            <span className="text-[10px] tracking-[0.3em] uppercase text-amber-300/80 font-medium">
              Read Article
            </span>
            <motion.div
              className="size-14 rounded-full border border-amber-300/20 flex items-center justify-center bg-amber-300/5 backdrop-blur-sm"
              whileHover={{
                scale: 1.1,
                rotate: 45,
    ...
    >
      ...
      <div className="relative text-center space-y-10">
        ...
        <p className="text-white/25 text-lg md:text-xl max-w-md mx-auto font-light leading-relaxed">
          The ink is still drying on new entries.
          <br />
          <span className="text-white/40">Thoughts taking shape soon!</span>
        </p>
      </div>
    </motion.div>
  );
